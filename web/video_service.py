...
categories = ['跳舞旋转', '吹蜡烛', '吹干头发', '滑雪', '打保龄球', '刷牙', '倒立走', '跳绳', '掷铁饼', '引体向上 ','刷毛','鞍马','开合跳','跳水','弹钢琴','站立','静止环','开枪设计','坐下','蛙泳','摆动', '跳远', '足球杂耍',
  '锤击','推东西','招手','溜溜球','排球扣球','吹长笛','台球','引体向上','皮划艇','游艇游行','墙上俯卧撑', '铅球','剪发','射弓箭','撑杆跳高','高低杠','太极','跳高','拳击','开车打电话','漂流','冲浪','拖地', '刮胡子', '弹西塔琴', '打沙袋', '弯腰拿东西', '跳跃', '跑步', '转呼啦圈', '悬崖跳水', '爬泳', '弹吉他', '倒水', '网球挥拍', '骑自行车', '打击双面鼓', '击剑', '棒球挥杆'
